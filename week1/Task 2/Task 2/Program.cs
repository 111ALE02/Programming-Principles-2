...
namespace Task2
{
    class Program
    {
        class Student //СОздадим класс
        {
            ...
            {    //cКонструктор с двумя переменными (Именем и айдишкой)
            ...
            {
                year++;
                Console.WriteLine("Year of student: " + year); //Вывод инкрементированного года
            }
        }
        static void Main(string[] args)             //Галвная функция Main
        {
            Student s1 = new Student("Alen", "18BD110887"); //СОздаем нвоыйй обьект класса Student и закидываем туда значения
